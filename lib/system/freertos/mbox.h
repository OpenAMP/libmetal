...
/*
 * @file	mbox.h
 * @brief	FreeRTOS mbox primitives for libmetal.
 *
 * Note that for now these are just stubs.
 */

#ifndef __METAL_MBOX_FREERTOS__H__
#define __METAL_MBOX_FREERTOS__H__
 ...
 * @return	0 on success. Negative value on failure.
 */
extern int __metal_mbox_enable(metal_mbox_t *mbox);
 ...
 * @return	0 on success. Negative value on failure.
 */
extern int __metal_mbox_disable(metal_mbox_t *mbox);
...
#endif /* __METAL_MBOX_FREERTOS__H__ */
